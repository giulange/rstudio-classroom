#!/bin/bash
# DESCRIPTION
#  This script runs the PHP-APACHE container in Pedometrics VM
...
WEBAPPS=/home/giuliano/docker-persistencies/php-rstudio/html
AP_BOOK=/home/giuliano/AP_book/online
...
-v $AP_BOOK:/var/www/html/ap_book \
-p $PORT_WEB:80 \
-p $PORT_SSL:443 \
-t \
$IMAGE_NAME
