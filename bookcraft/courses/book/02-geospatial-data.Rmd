...
knitr::kable(
  head(cars, 10), caption = 'Here is a preview of the cars data frame',
  booktabs = TRUE
)
```
...
```{r cars-df, fig.cap='This is a figure created using the examples provided in documentation.', out.width='80%', fig.asp=.75, fig.align='center'}
