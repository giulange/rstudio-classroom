...
This is the section dedicated to the course _Geografia e Valutazione del Suolo_ (`r params$gevs_link_course`) in the master's degree in _SCIENZE FORESTALI ED AMBIENTALI_ (`r params$gevs_link_degree`).

Course information are available at the [teacher's web page](`r paste0("https://www.docenti.unina.it/glangella/",params$gevs_link_year,"/",params$gevs_link_degree,"/",params$gevs_link_course)`).
