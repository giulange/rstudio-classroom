...
```{r pressure, eval=FALSE, echo=FALSE, fig.cap="Simple Feature Geometries", out.width = '60%', fig.align='left'}
knitr::include_graphics("/home/giuliano/artwork/sf-classes.png")
```
...
#### Existent vector geodata: examples using Climatic Ground Stations
(I could add one more examples using my smart Agrometeorological Weather Station).
(I have to properly use my dataset in the document, for instance I can list the directory limiting to the objects I need + I could provide a link in the document to download the file used (interesting for the public not for the students))

##### Standard Agrometeorological Ground Stations
...we will use the temperature and precipitation measured at ground weather stations...




##### Smart Agrometeorological Groud Stations (IoT)
