...
```{r install_libs, eval=FALSE, echo=1:5}
install.packages("sf")
...
### Load libraries
```{r load_libs, results='hide', echo=1:6}
...
```{r SF-geometries, fig.cap='Simple Feature Geometries.', out.width = '60%', fig.align='left', echo=FALSE}
...
```{r fig-sfg-point, fig.cap='Example of POINT geometry.', out.width='100%', fig.asp=.75, fig.align='left'}
...
```{r fig-sfg-linestring, fig.cap='Example of LINESTRING geometry.', out.width='100%', fig.asp=.75, fig.align='left'}
...
```{r fig-sfg-polygon, fig.cap='Example of POLYGON geometry.', out.width='100%', fig.asp=.75, fig.align='left'}
...
```{r fig-sfg-multipoint, fig.cap='Example of MULTIPOINT geometry.', out.width='100%', fig.asp=.75, fig.align='left'}
...
```{r fig-sfg-multilinestring, fig.cap='Example of MULTILINESTRING geometry.', out.width='100%', fig.asp=.75, fig.align='left'}
...
```{r fig-sfg-multipolygon, fig.cap='Example of MULTIPOLYGON geometry.', out.width='100%', fig.asp=.75, fig.align='left'}
...
Visualze it:
```{r fig-sfg-geometrycollection, fig.cap='Example of GEOMETRYCOLLECTION geometry.', out.width='100%', fig.asp=.75, fig.align='left'}
...
```{r fig-sf-valteldsm, fig.cap='Digital Soil Map of Telese Valley.', out.width='100%', fig.asp=.75, fig.align='left'}
...
```{r fig-ER-station, fig.cap='Emilia Romagna Region with MODENAURB station.', out.width='100%', fig.asp=.75, fig.align='left'}
...
```{r tab-vector-drivers, tidy=TRUE, echo=FALSE}
tab = st_drivers()

tab[1] <- cell_spec(tab[[1]], color = "white", bold = T, background = 'orange')
